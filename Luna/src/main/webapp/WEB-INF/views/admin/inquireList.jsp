         ...
         <table class="table table-striped"
            ...
            <thead>
               <tr>
                  ...
                  <th style="background-color: #eeeeee; text-align: center;">답변달기</th>
            ...
            <tbody>
             ...
             <td>${row.reply}</td>
             <td><a href="inquirewrite.ado?seq=${row.seq}" class="btn btn-primary">답변</a></td>
             <td><a href="inquiredelete.ado?seq=${row.seq}" class="btn btn-primary">삭제</a></td>
             </tr>
             </c:forEach>
            </tbody>
         </table>
