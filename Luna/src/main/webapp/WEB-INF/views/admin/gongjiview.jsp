      ...
      <form name="form2" action="gongjiupdate.ado" method="POST">
         <table class="table table-bordered">
            <tbody>
               <tr>
                  <th>제목:</th>
                  <td><input type="text" name="title" placeholder="title" id="title"
                     value="${num.title}" class="form-control" />
               ...
               <td colspan="2"><input type="submit" id="update" value="수정" class="btn btn-primary pull-right" /> 
                <input type="button" value="삭제"
                     class="btn btn-primary pull-right" onclick="javascript:location.href='gongjidelete.ado?num=${num.num}'" /></td>
               </tr>
            </tbody>
         </table>
      </form>
