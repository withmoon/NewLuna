...
<head>
<script src="<c:url value="/resources/manager/jquery/moment.min.js"/>"></script>
<script src="<c:url value="/resources/manager/jquery/angular.min.js"/>"></script>
<script src="<c:url value="/resources/manager/js/calendar.js"/>"></script>
...
<link type="text/css" rel="stylesheet" href="<c:url value="/resources/manager/css/calendar.css"/>"></link>
<link type="text/css" rel="stylesheet" href="<c:url value="/resources/manager/css/refund.css"/>"></link>
<meta charset="UTF-8">
...
<body>
	...
	<nav id="TopNav">
		...
		<div id="TopMenu1">
			<!-- 좌측상단 로고 -->
			<div id="letflogo">
				<img class="logo" src="<c:url value="/resources/manager/css/manager2.css"/>"></img>
			</div>
		...
		<section id="msec">
			...
			<div id="rcenter">
				...
				<div id="namesearch">
					...
					<label>어떤방식으로 화면이 늘어났을때 만들건지 테스트 중</label><br /> <label>스크롤바를
						만들지 웹을 늘릴지</label>
				</div>
			</div>
		</section>
