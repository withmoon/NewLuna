...
public class AdminMailController {
	...
	public String sendemail(MultipartHttpServletRequest mpreq,@RequestParam("id") String id, @RequestParam("email") String email,
			@RequestParam(value="content", required = false, defaultValue = "") String contents,
			@RequestParam(value = "title", required = false, defaultValue = "") String titles) throws MessagingException, IllegalStateException, IOException{
